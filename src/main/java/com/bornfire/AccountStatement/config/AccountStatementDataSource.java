...
@EnableJpaRepositories(basePackages = "com.bornfire.AccountStatement.entities", entityManagerFactoryRef = "datasrc", transactionManagerRef = "datasrcTransactionManager")
public class AccountStatementDataSource {
    ...
    public LocalSessionFactoryBean datasrc() throws SQLException {
        ...
        sessionFactory.setPackagesToScan("com.bornfire.AccountStatement.entities");
